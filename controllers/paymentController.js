...
exports.getCheckoutSession = catchAsync(async(req, res, next) =>{
 ...
 const session = await stripe.checkout.sessions.create({
    ...
    success_url: `${req.protocol}://${process.env.FRONT_ENV_PROTOCOL}/profile/premium/result/?status=success`,
    cancel_url: `${req.protocol}://${process.env.FRONT_ENV_PROTOCOL}/profile/premium/result/?status=fail`,
